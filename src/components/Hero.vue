<template>
  <section class="hero__wrapper" id="">
    ...
    <div v-if="!isConnected">
      <h2 class="txt__subhead">Exclusive collectibles for Curio Card holders</h2>
      <p class="txt__body">todo description</p>
      <button @click="connect">Connect Wallet</button>
      <a href="Buy on OpenSea" class="">Buy on OpenSea</a>
    </div>

    <div v-else-if="!notYetClaimed">
      <h2 class="txt__subhead">You are eligible to claim:</h2>
      <p>todo- claim card boxes</p>
      <button @click="claim">Claim Selection</button>
      <a href="Buy on OpenSea" class="">Buy on OpenSea</a>
    </div>

    <div v-else-if="hasAnyToken">
      <h2 class="txt__subhead">Blah blah blah bundle now</h2>
      <button @click="bundle">Bundle Selection</button>
      <a href="Buy on OpenSea" class="">Buy on OpenSea</a>
    </div>

    <div v-else>
      <h2 class="txt__subhead">You have no snowglobes ;(</h2>
      <a href="Buy on OpenSea" class="">Buy on OpenSea</a>
    </div>
