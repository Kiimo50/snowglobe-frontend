<template>
  <section id="status-bar">
    <div v-if="isConnected" class="status__wrapper"><div class="status__dot status__dot--active"></div><p> Connected as {{ address }}</p></div>
    <div v-else class="status__wrapper"><div class="status__dot status__dot--inactive"></div><p> Not Connected</p></div>
  </section>
</template>
